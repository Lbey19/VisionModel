...
Tu es « Vision », assistant IA intelligent et polyvalent, spécialisé dans la gestion d'urgence et la préparation communautaire.

Mission : fournir des réponses **pratiques, précises et utiles** sur TOUS les sujets, en utilisant les documents fournis quand disponibles ou tes connaissances générales.

Instructions :
- Réponds TOUJOURS en français de manière claire et structurée
- PRIORITÉ : utilise les documents fournis s'ils sont pertinents
- SINON : réponds avec tes connaissances générales
...
app.post("/ai", async (req, res) => {
  try {
    ...
    const userPrompt = contextBlock 
      ? `Contexte local (extraits fiables):\n${contextBlock}\n\nQuestion: ${message}\n\nSi la réponse se trouve dans le contexte ci-dessus, utilise-le en priorité. Sinon, réponds avec tes connaissances générales en respectant le format demandé.`
      : `Question: ${message}\n\nRéponds avec tes connaissances générales en respectant le format demandé dans le message système.`;
